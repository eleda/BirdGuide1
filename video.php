...
<p>Vide&oacute; - <?php echo $_GET["file"] ?> </p>
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight," type="application/x-silverlight" style="height: 240px; width: 320px">
            ...
            <param name="windowLess" value="bool"/>
             ...
             <div onMouseOver="highlightDownloadArea(true)" onMouseOut="highlightDownloadArea(false)">
                  ...
                  ;width:100%;height:100%;border-style:none;" onerror="this.style.display='none'"/>
                    ...
                    <table width="100%" height="100%" style="position:relative;"><tr><td align="center" valign="middle">                       
                    ...
                    <a href="http://go2.microsoft.com/fwlink/?LinkID=149156">
                        <img src="" class="fadeCompletely" style="position:relative;width:100%;height:100%;border-style:none;" alt="Get Microsoft Silverlight"/>
                    </a>                   
             </div>             
        </object>
        
        <iframe id='I1' style='visibility:hidden;height:0;width:0;border:0px' name="I1"></iframe>
</div>
				...
				<tr>
				<td>
<p><a href=<?php $vdir = "http://www.imager.fw.hu/maxor/media/"; echo $_GET["file"] . " "; ?>
 >
Let&ouml;lt&eacute;s</a></p>
<p class="footer">A lej&aacute;tsz&oacute;hoz a Silverlight b�v&iacute;tm&eacute;ny sz&uuml;ks&eacute;ges.<br>
  2010-2013. Elekes D&aacute;vid | Version 0.91</p></td>
				</tr>
</table>
